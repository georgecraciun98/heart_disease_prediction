...
class EmailVerificationTest(APITestCase):
    ...
    user_details_url = "/api/auth/users/"
    resend_verification_url="/api/auth/users/resend_activation/"
    # user infofmation
    user_data = {
    ...
    def test_register_with_email_verification(self):
        ...
        self.assertEqual(json['results'][0]["email"], self.user_data["email"])
        self.assertEqual(json['results'][0]["username"], self.user_data["username"])
